...
e(n.msg),delete l[n.hash]):
// console.log('f.oMc e j:' + j);
a.oM(t)}}catch(t){console.log(t)}},0)}static buildChild(t,e){i.w.addEventListener(c,async t=>{const e=t.data;if(e&&"string"==typeof e&&0===e.indexOf("{"))try{const t=JSON.parse(e),n=t.hash;console.log("f.oN a o.hash:"+n);const o=await a.oM({data:t});if(console.log("f.oN b h:"+n),n){const t={msg:o,hash:n};u.postToChild(JSON.stringify(t))}}catch(t){console.log(t)}},0);const n=i.iframe("fullFrame",t);i.b.appendChild(n),n.onload=t=>{setTimeout(()=>{a.oL(t)},100)},e&&(n.style.height=window.innerHeight+"px",n.style.width="100%",n.style.border="0"),a.i=n}static setOnLoad(t){a.oL=t}static setOnMessageAtChild(t){u.isChildFrame()&&(a.oM=t)}static setOnMessage(t){a.oM=t}static postToChild(t){
